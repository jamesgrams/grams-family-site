<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    ...
    <div class="post">
        ...
        <?php if ( !isset($args["h"]) ) : ?><a href="<?php comments_link(); ?>"><?php printf( _nx( '%1$s comment', '%1$s comments', get_comments_number(), "comments number" ), number_format_i18n( get_comments_number() ) );?></a><?php endif; ?>
